...
root -q -b -l GoSamConverterToGenLevelAcceptance.C+O\(\"$1\",\"${WORKDIR}/converted_tree.root\"\)
cat ${WORKDIR}/converted_tree.root | gfal-save $2
rm ${WORKDIR}/converted_tree.root
